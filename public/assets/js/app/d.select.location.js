...
function getAdminDivisions(countryCode, adminType, selectedAdminCode) {
  ...
  $.ajax({
    ...
    $("#adminCode")
      .empty()
      .append('<option value="0">' + lang.select.admin + "</option>")
      .val("0")
      .trigger("change");
    $("#cityId")
      .empty()
      .append('<option value="0">' + lang.select.city + "</option>")
      .val("0")
      .trigger("change");
    ...
    if (typeof obj.error !== "undefined") {
      $("#adminCode")
        ...
        .remove()
        .end()
        .append('<option value="0"> ' + obj.error.message + " </option>");
...
function getSelectedCity(countryCode, cityId) {
  ...
  $.ajax({
    ...
    .done(function (data) {
      $("#cityId")
        .empty()
        .append('<option value="' + data.id + '">' + data.text + "</option>")
        .val(data.id)
        .trigger("change");
      return data.id;
    })
