        ...
        try {
            ...
            if ($pdo instanceof \PDO) {
                ...
                if (
                    ...
                    $isValidCharacterSet = ($defaultCharacterSetAndCollation['DEFAULT_CHARACTER_SET_NAME'] == $characterSetVars['character_set_client']
                    ...
                    $isValidCollation = ($defaultCharacterSetAndCollation['DEFAULT_COLLATION_NAME'] == $collationVars['collation_connection']
