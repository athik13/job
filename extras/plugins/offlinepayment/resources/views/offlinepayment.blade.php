						...
						<div class="card-body">
							...
							<ul>
								<li>
									...
									{{ trans('offlinepayment::messages.Ad') }} #{{ (isset($post)) ? $post->id : 'ID' }} - <span class="package-name"></span>
								</li>
								<li>
							...
							{!! (isset($offlinepaymentPaymentMethod) and !empty($offlinepaymentPaymentMethod->description)) ? $offlinepaymentPaymentMethod->description : '...' !!}
						</div>
					</div>
				</div>
			</div>
